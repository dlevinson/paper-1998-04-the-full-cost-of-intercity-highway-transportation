...
means variables= lntotexp lnauto lncomb lnsing lnpurb lnmiles
   iaa iac ias iap iam icc ics icp icm iss isp ism ipp ipm imm by x.
...
regression variables= totexp auto comb sing
  /dependent=totexp
  /method=enter
  /save resid (resid2).
