...
regression variables=lntotexp lnauto lncomb lnsing lnplabor
  lnirate lnmiles lnpop90
  /dependent=lntotexp
  /method=enter.

regression variables=lntotexp lnauto lncomb lnsing lnplabor lnirate
   lnpop90
   /dependent=lntotexp
   /method=enter.

*compute wres2=1/(resid22*resid22).
*regression variables= lntotexp lnauto lncomb lnsing lnplabor
*  lnirate lnmilhat
*  /regwgt wres2
*  /dependent=lntotexp
