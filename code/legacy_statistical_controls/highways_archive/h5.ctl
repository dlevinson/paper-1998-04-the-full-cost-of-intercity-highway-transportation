...
regression variables=totexp auto comb sing plabor psurf
  irate miles width
  /dependent=totexp
  /method=enter
  /save resid (resid1).
...
regression variables=lntotexp lnauto lncomb lnsing lnplabor lnpsurf
  lnirate lnmiles lnwidth
  /dependent=lntotexp
  /method=enter
  /save resid (resid2).


compute wres2=1/(resid2*resid2).
...
regression variables=varexp auto comb sing plabor psurf
  irate miles width
  /dependent=varexp
  /method=enter
  /save resid (resid5).
...
regression variables=lnvarexp lnauto lncomb lnsing lnplabor lnpsurf
  lnirate lnmiles lnwidth
  /dependent=lnvarexp
  /method=enter
  /save resid (resid4).
