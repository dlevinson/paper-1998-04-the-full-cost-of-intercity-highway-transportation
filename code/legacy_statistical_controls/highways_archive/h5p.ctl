...
compute texppm=totexp/miles.
compute lntexppm=ln(texppm).
compute vmtpm=vmt/miles.
compute lnvmtpm=ln(vmtpm).
compute percom=comb/vmt.
comptue persin=sing/vmt.
compute lnpercom=ln(percom).
compute lnpersin=ln(persin).

regression variables=lntexppm lnvmtpm lnplabor lnpsurf lnirate lnmiles 
  lnpercom lnpersin
  /dependent=lntexppm
  /method=enter.

regression variables=lntexppm lnvmtpm lnplabor lnpsurf lnirate lnmiles lnh 
  lnpercom lnpersin
  /dependent=lntexppm
  /method=enter.
