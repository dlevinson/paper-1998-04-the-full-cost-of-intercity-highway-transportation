...
compute mton=auto*(0.4+1.1)+sing*(3.6+8.1)+comb*(3.8+2*9.8+2*9.9).
compute lnmton=ln(mton).

regression variables=totexp vmt sing comb plabor psurf irate miles
  /dependent=totexp
  /method=enter.

regression variables=lntotexp lnauto lnsing lncomb
 lnplabor lnpsurf lnirate
  /dependent=lntotexp
  /method=enter.
