...
regression variables=lntotexp lnauto lncomb lnsing lnplabor lnirate lnpsurf
  /dependent=lntotexp
  /method=enter.

regression variables=lnvarexp lnauto lncomb lnsing lnplabor lnirate lnpsurf
  /dependent=lnvarexp
  /method=enter.

regression variables=lncapnew lnauto lncomb lnsing lnplabor lnirate lnpsurf
  /dependent=lncapnew
  /method=enter.

compute x=1.
means variables=capnew totexp varexp by x.
